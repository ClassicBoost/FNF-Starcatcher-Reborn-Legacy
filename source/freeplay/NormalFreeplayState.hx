...
class NormalFreeplayState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if((ClientPrefs.autoPlayFreeplaySongs || space) && (instPlaying != curSelected))
		{
			...
			var file:String = Paths.json(PlayState.SONG + '/' + PlayState.SONG, false);
		...
		else if (accepted)
		{
			...
			PlayState.SONG = Song.loadFromJson(poop, songLowercase, false);
			PlayState.isStoryMode = false;
