...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		**/
		...
		var folderSongs:Array<String> = CoolUtil.returnAssetsLibrary('credits', 'assets');

		///*
		for (i in 0...Main.creditsStuff.length)
		{
			addWeek(Main.creditsStuff[i][0], i, Main.creditsStuff[i][1], Main.creditsStuff[i][2]);
	...
	public function addSong(songName:String, weekNum:Int, songCharacter:String, songColor:FlxColor)
	{
		...
		{ //*/
			songs.push(new CreditsMetadata(songName, weekNum, songCharacter, songColor));
