	...
	public function new(curStage)
	{
		...
		if (PlayState.determinedChartType == "FNF")
		{
			...
			switch (CoolUtil.spaceToDash(PlayState.SONG.song.toLowerCase()))
			{
				...
				case 'wtf':
					curStage = 'baren';
				// OG SHIT
				case 'spookeez-og' | 'south-og' | 'monster':
					curStage = 'spooky-og';
				case 'pico-og' | 'blammed-og' | 'philly-nice-og':
					curStage = 'philly-og';
		...
		switch (curStage)
		{
			case 'forest':
				...
				spacelol = new FNFSprite(0,-300).loadGraphic(Paths.image('backgrounds/shared/space-lit'));
				spacelol.scrollFactor.set(0, 0);
				spacelol.setGraphicSize(Std.int(spacelol.width * 2));
				spacelol.updateHitbox();
				...
				house = new FNFSprite(-250,-200).loadGraphic(Paths.image('backgrounds/' + curStage + '/house'));
			...
			case 'baren':
				...
				var bg:FNFSprite = new FNFSprite(-600,-300).loadGraphic(Paths.image('backgrounds/shared/sky-night'));
				bg.scrollFactor.set(0, 0);
				bg.setGraphicSize(Std.int(bg.width * 3));
				bg.updateHitbox();
				add(bg);

				var baren:FNFSprite = new FNFSprite(-400,-1300).loadGraphic(Paths.image('backgrounds/baren'));
			...
			case 'spooky-og':
				...
				var hallowTex = Paths.getSparrowAtlas('backgrounds/classic/' + curStage + '/halloween_bg');
			...
			case 'philly-og':
				...
				var bg:FNFSprite = new FNFSprite(-100).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/sky'));
				bg.scrollFactor.set(0.1, 0.1);
				add(bg);

				var city:FNFSprite = new FNFSprite(-10).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/city'));
				...
				for (i in 0...5)
				{
					var light:FNFSprite = new FNFSprite(city.x).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/win' + i));
				...
				var streetBehind:FNFSprite = new FNFSprite(-40, 50).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/behindTrain'));
				add(streetBehind);

				phillyTrain = new FNFSprite(2000, 360).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/train'));
				add(phillyTrain);
				...
				var street:FNFSprite = new FNFSprite(-40, streetBehind.y).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/street'));
				add(street);
			case 'highway-og':
				curStage = 'highway-og';
				PlayState.defaultCamZoom = 0.90;

				var skyBG:FNFSprite = new FNFSprite(-120, -50).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/limoSunset'));
				...
				var overlayShit:FNFSprite = new FNFSprite(-500, -600).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/limoOverlay'));
				...
				var limoTex = Paths.getSparrowAtlas('backgrounds/classic/' + curStage + '/limoDrive');
				...
				fastCar = new FNFSprite(-300, 160).loadGraphic(Paths.image('backgrounds/classic/' + curStage + '/fastCarLol'));
			// loadArray.add(limo);
			case 'mall':
				curStage = 'mall';
