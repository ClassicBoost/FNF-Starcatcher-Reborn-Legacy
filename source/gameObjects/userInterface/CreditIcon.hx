...
class CreditIcon extends FlxSprite
{
	...
	public function updateIcon(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		var iconPath = char;
		if (!FileSystem.exists(Paths.getPath('images/characters/icons/credits/' + iconPath + '.png', IMAGE)))
		{
		...
		antialiasing = true;
		var iconGraphic:FlxGraphic = Paths.image('characters/icons/credits/' + iconPath);
