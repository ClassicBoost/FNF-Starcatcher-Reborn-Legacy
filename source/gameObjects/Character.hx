...
class Character extends FNFSprite
{
	...
	public var curCharacter:String = 'ryan';
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/sprites/classic/GF_assets');
				frames = tex;
				...
				barColor = 0xFFA5004D;
			case 'gf-christmas':
				tex = Paths.getSparrowAtlas('characters/sprites/main/gfChristmas');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
				...
				barColor = 0xFFA5004D;
			case 'gf-car':
				tex = Paths.getSparrowAtlas('characters/sprites/classic/gfCar');
				frames = tex;
				...
				barColor = 0xFFA5004D;
			case 'gf-pixel':
				tex = Paths.getSparrowAtlas('characters/sprites/main/gfPixel');
				frames = tex;
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('characters/sprites/classic/DADDY_DEAREST');
				frames = tex;
				...
				barColor = 0xFFAF66CE;
			case 'spooky':
				tex = Paths.getSparrowAtlas('characters/sprites/classic/spooky_kids_assets');
				frames = tex;
				...
				barColor = 0xFF2E492D;
			case 'jeri-gara':
				frames = Paths.getSparrowAtlas('characters/sprites/main/Jeri-Gara');
			...
			case 'mom':
				...
				barColor = 0xFFD8558E;
			case 'mom-car':
				tex = Paths.getSparrowAtlas('characters/sprites/classic/momCar');
				frames = tex;
				...
				barColor = 0xFFD8558E;
			case 'monster':
				tex = Paths.getSparrowAtlas('characters/sprites/main/Monster_Assets');
				frames = tex;
			...
			case 'monster-christmas':
				tex = Paths.getSparrowAtlas('characters/sprites/main/monsterChristmas');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
			...
			case 'bf-christmas':
				...
				barColor = 0xFF31B0D1;
			case 'bf-car':
				var tex = Paths.getSparrowAtlas('characters/sprites/classic/bfCar');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				...
				barColor = 0xFF31B0D1;
			case 'bf-pixel':
				frames = Paths.getSparrowAtlas('characters/sprites/main/bfPixel');
				...
				barColor = 0xFF31B0D1;
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('characters/sprites/main/bfPixelsDEAD');
			...
			case 'senpai':
				frames = Paths.getSparrowAtlas('characters/sprites/main/senpai');
			...
			case 'senpai-angry':
				...
				barColor = 0xFFFFAA6F;
			case 'spirit':
				frames = Paths.getPackerAtlas('characters/sprites/main/spirit');
			...
			case 'parents-christmas':
				frames = Paths.getSparrowAtlas('characters/sprites/main/mom_dad_christmas_assets');
				...
				playAnim('idle');
				barColor = 0xFFD655B6;
			// IF YOU KNOW YOU KNOW CHARACTERS
			case 'arc':
				frames = Paths.getSparrowAtlas('characters/sprites/iykyk/Arc');
				// she has no frames since she never sings
				animation.addByPrefix('idle', 'idle', 24, false);
				...
				barColor = 0xFF7FAAFF;
			case 'poptop':
				frames = Paths.getSparrowAtlas('characters/sprites/iykyk/poptop');
